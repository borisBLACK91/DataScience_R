...
#Instructions
#Using the probability of choosing a cyan ball, p, calculate the probability of 
#choosing any other ball.
1-p
...
#replacement. What is the probability that the first draw is cyan and that the 
#second draw is not cyan?
#Instructions
...
#recording the color, return it back to the box and shake the box. We call this 
