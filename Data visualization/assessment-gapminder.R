...
#The Gapminder Foundation (www.gapminder.org) is a non-profit
#organization based in Sweden that promotes global development
#through the use of statistics that can help reduce misconceptions 
...
#Note that there is quite a bit of variability in life expectancy 
#and fertility with some African countries having very high life expectancies.
...
#the regions of Africa are labeled in the data frame!
...
#Exercise 3. Life expectancy vs fertility - part 3 - selecting 
#country and region While many of the countries in the high
#life expectancy/low fertility cluster are from Northern Africa, 
#three countries are not.
#Create a table showing the country and region for the African
#countries (use select) that in 2012 had fertility rates of 3 or 
#less and life expectancies of at least 70.
...
#The Vietnam War lasted from 1955 to 1975. Do the data support
#war having a negative effect on life expectancy? We will create 
#a time series plot that covers the period from 1960 to 2010 of life
#expectancy for Vietnam and the United States, using color to distinguish 
#the two countries. In this start we start the analysis by generating a table.
#Use filter to create a table with data for the years from 1960 to 2010 in Vietnam
...
#Now that you have created the data table in Exercise 4, it is time to plot 
#the data for the two countries.
#Use geom_line to plot life expectancy vs year for Vietnam and the
#United States and save the plot as p. The data table is stored in tab.
...
#Use mutate to create a dollars_per_day variable, which is defined 
#as gdp/population/365. Create the dollars_per_day variable for African 
#countries for the year 2010.Remove any NA values.
...
#two exercises to create density plots for multiple years.
#Instructions
...
#Use the fill and position arguments where appropriate to create the 
#stacked density plot of each region.
...
#Instructions
#Generate dollars_per_day using mutate and filter for the year 2010 for African 
#countries.
#Remember to remove NA values.
#Store the mutated dataset in gapminder_Africa_2010.
#Make a scatter plot of infant_mortality versus dollars_per_day for 
...
#over 10% and dollars per day of about 1.
